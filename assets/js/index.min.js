...
function randomSiteCover(){var o=Math.floor(9*Math.random()+1);$(".header-big").css("background-image","url("+Maple.blogUrl+"/assets/images/covers/cover_bg_"+o+".jpg)")}$(function(){if(Maple.enableRandomCover&&randomSiteCover(),$(".indicator").click(function(){var o=$(".site-content").offset().top;$("html,body").animate({scrollTop:o},500)}),$("body").hasClass("paged")){var o=$(".site-content").offset().top;$("html,body").animate({scrollTop:o},0),$(".header-big").removeClass("invisible")}});