...
function randomSiteCover(){var e=Math.floor(9*Math.random()+1),o=$(".header-big").css("backgroundImage");""!==o&&"none"!==o&&"undefined"!==o||$(".header-big").css("background-image","url("+VBlog.url+"/assets/images/covers/cover-bg-"+e+".jpg)");for(var a=$(".cover-image"),n=0;n<a.length;n++){var r=a[n];""!==(o=r.style.backgroundImage)&&"none"!==o&&"undefined"!==o||(e=Math.floor(9*Math.random()+1),r.style.backgroundImage="url("+VBlog.url+"/assets/images/covers/cover-bg-"+e+".jpg)")}}$(function(){if(VBlog.enableRandomCover="undefined"==typeof enableRandomCover||enableRandomCover,VBlog.enableRandomCover&&randomSiteCover(),$(".indicator").click(function(){var e=$(".site-content").offset().top;$("html,body").animate({scrollTop:e},500)}),$("body").hasClass("paged")){var e=$(".site-content").offset().top;$("html,body").animate({scrollTop:e},0),$(".header-big").removeClass("invisible")}});