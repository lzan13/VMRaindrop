...
function randomSiteCover(){Math.floor(9*Math.random()+1);setRandomBackgound(document.getElementById("header-big"));for(var n=$(".cover-image"),e=0;e<n.length;e++)setRandomBackgound(n[e])}function infiniteScroll(){$(".posts-container").infiniteScroll({path:".pagination-next a",hideNav:".pagination-nav",status:".pagination-status",append:".post-card",history:!1}),$(".posts-container").on("append.infiniteScroll",function(n,e,o,a){for(var t=0;t<a.length;t++){setRandomBackgound(a[t].getElementsByClassName("cover-image")[0])}})}function setRandomBackgound(n){var e=n.style.backgroundImage;if(""===e||"none"===e||"undefined"===e){var o=Math.floor(9*Math.random()+1);n.style.backgroundImage="url("+VBlog.url+"/assets/images/covers/cover-bg-"+o+".jpg)"}}$(function(){if(VBlog.enableRandomCover="undefined"==typeof enableRandomCover||enableRandomCover,VBlog.enableInfiniteScroll="undefined"==typeof enableInfiniteScroll||enableInfiniteScroll,VBlog.enableRandomCover&&randomSiteCover(),VBlog.enableInfiniteScroll&&infiniteScroll(),$(".indicator").click(function(){var n=$(".site-content").offset().top;$("html,body").animate({scrollTop:n},500)}),$("body").hasClass("paged")){var n=$(".site-content").offset().top;$("html,body").animate({scrollTop:n},0),$("#header-big").removeClass("invisible")}});