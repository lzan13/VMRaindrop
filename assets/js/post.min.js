...
function addBlankTargetForLinks(){$('.md-preview a[href^="http"]').each(function(){$(this).attr("target","_blank")})}function showBigImage(e){$("#show-image-layer").removeClass("is-hidden"),$("#show-image-layer").addClass("is-displayed");var o=$(e.target).attr("src").replace(/(-v256|-v512|-v1024)/g,"");$("#show-image-layer img").attr("src",o),$("body").css("overflow","hidden")}function showSrcImage(){window.open($("#show-image-layer img").attr("src"))}function exitFullScreen(){$("#show-image-layer").hasClass("is-hidden")||($("#show-image-layer").addClass("is-hidden"),$("#show-image-layer").removeClass("is-displayed"),$("#show-image-layer img").attr("src",""),$("body").removeAttr("style"))}function copyCode(e){var o=$(e).nextAll("code").text();clipboard.copy(o).then(function(){$(e).text("已复制"),$(e).attr("title","代码已成功复制").tooltip("fixTitle").tooltip("show")})}function showSlide(e){$(".navbar-side").css("right",0),$("#toc").toc({selectors:"h1,h2,h3",container:".md-preview",prefix:"toc",highlightOffset:1,anchorName:function(e,o,t){return t+e}}),setTimeout(function(){setTocPosition()},10)}function hideSlide(e){$(".navbar-side").css("right","-308px"),$("#toc").empty()}function setTocPosition(){var e=$(".md-preview").offset().top+$(".md-preview").outerHeight()-$("#toc").outerHeight(),o=$(window).scrollTop(),t=$("header").outerHeight();o<=t?$(".toc-wrapper").removeClass("position-fixed").addClass("position-absolute").removeAttr("style"):t<o&&o<=e?($(".toc-wrapper").removeAttr("style"),$(".toc-wrapper").removeClass("position-absolute").addClass("position-fixed")):$(".toc-wrapper").removeClass("position-fixed").addClass("position-absolute").css("top",e-$(".md-preview").offset().top)}$(document).keydown(function(e){if(27==(e=e||event).keyCode)return exitFullScreen(),!1}),$(function(){hljs.initHighlightingOnLoad(),0<$(".md-preview h1,.md-preview h2,.md-preview h3").length&&$(".navbar-side").removeClass("hidden"),$(".toc-btn").click(function(e){$(e.currentTarget).hasClass("show-toc")?hideSlide(e):showSlide(e),$(e.currentTarget).toggleClass("show-toc")}),$(window).scroll(function(){setTocPosition()}),$(window).scroll(function(){300<=$(window).scrollTop()?$("#go-to-top").fadeIn(300):$("#go-to-top").fadeOut(300)}),$("#go-to-top").click(function(){return $("html,body").animate({scrollTop:"0px"},600),!1}),$(".md-preview img").click(function(e){showBigImage(e)}),$("#show-image-layer .show-image-src").click(function(){showSrcImage()}),$("#show-image-layer").click(function(){exitFullScreen()}),$(document).bind("DOMNodeInserted",function(){addBlankTargetForLinks()}),$(".md-preview pre").hover(function(){if($(this).children(".copy-code-wrapper").length<=0){$("<a data-toggle='tooltip' data-placement='right' title='点击复制代码' class='copy-code-wrapper' onclick='copyCode(this);'>复制</a>").prependTo($(this));var e=$(this).offset().top,o=$(this).offset().left+$(this).outerWidth()-$(this).children(".copy-code-wrapper").outerWidth();$(this).children(".copy-code-wrapper").offset({top:e,left:o}),$(this).children(".copy-code-wrapper").tooltip()}},function(){$(this).children(".copy-code-wrapper").remove()})});